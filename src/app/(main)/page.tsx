          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              ...
              <span
                style={{
                  background:
                    "linear-gradient(135deg, #c0a84f, #d4bc72, #c0a84f)",
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/about"
                className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl font-semibold text-white border border-white/25 hover:border-white/50 hover:bg-white/8 transition-all duration-200 cursor-pointer text-base"
              >
                Learn More
              </Link>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {stats.map((stat, i) => (
              <div
                key={i}
                className="text-center p-6 bg-white rounded-2xl shadow-sm border border-[#E2E8F0] hover:shadow-md hover:border-[#c0a84f]/30 transition-all duration-200"
              >
                <div
                  className="text-3xl font-bold text-[#0e2b49] mb-1"
                  style={{ fontFamily: "Poppins, sans-serif" }}
                >
                  {stat.value}
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            ...
            <p className="text-[#64748B] max-w-xl mx-auto text-lg">
              Comprehensive programs designed to unlock your full communication
              potential.
            </p>
          </div>
          ...
          {coreCourses.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
              {coreCourses.map((course) => (
                <div
                  key={course._id}
                  className="group bg-white rounded-2xl p-6 border border-[#E2E8F0] hover:border-[#c0a84f]/40 hover:shadow-[0_8px_32px_rgba(14,43,73,0.1)] transition-all duration-300 hover:-translate-y-1 cursor-default"
                >
                  ...
                  <h3
                    className="text-base font-semibold text-[#0e2b49] mb-2"
                    style={{ fontFamily: "Poppins, sans-serif" }}
                  >
                    {course.title}
                  </h3>
          ...
          {coursePricing.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-3 gap-7 max-w-5xl mx-auto">
              {coursePricing.map((plan) => (
                <div
                  key={plan._id}
                  className={`relative rounded-2xl p-8 transition-all duration-300 hover:-translate-y-1 ${plan.featured ? "bg-gradient-to-br from-[#0e2b49] to-[#133a67] text-white shadow-[0_20px_60px_rgba(14,43,73,0.3)] scale-105" : "bg-[#F8FAFC] border border-[#E2E8F0] hover:border-[#c0a84f]/30 hover:shadow-[0_8px_32px_rgba(14,43,73,0.08)]"}`}
                >
                  {plan.featured && (
