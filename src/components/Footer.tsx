    ...
    <footer className="bg-[#0a2240] text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-2.5 mb-4">
              <div className="flex items-center justify-center w-9 h-9 rounded-lg bg-gradient-to-br from-[#c0a84f] to-[#d4bc72] shadow-md">
                <span className="text-[#0e2b49] font-bold text-sm" style={{ fontFamily: 'Poppins, sans-serif' }}>U</span>
              </div>
            ...
            <p className="text-white/60 text-sm leading-relaxed mb-5">
              Empowering Communication.<br />Transforming Personalities.
            </p>
            {/* Contact info */}
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-sm font-semibold text-white uppercase tracking-widest mb-5" style={{ fontFamily: 'Poppins, sans-serif' }}>
              Quick Links
            </h4>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {courses.map((course) => (
                <li key={course} className="text-sm text-white/60 flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-sm text-white/60 leading-relaxed mb-5">
              Ready to transform your communication skills? Take the first step today.
            </p>
            <Link
              href="/contact"
        ...
        <div className="border-t border-white/10 mt-12 pt-8 flex flex-col sm:flex-row justify-between items-center gap-3">
          ...
          <p className="text-sm text-white/40">
            ...
            <a
              ...
              className="text-[#c0a84f]/70 hover:text-[#c0a84f] transition-colors duration-200 underline underline-offset-2"
            >
              ThitaInfo
            </a>{" "}
            with love
